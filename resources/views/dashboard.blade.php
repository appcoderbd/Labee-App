                    ...
                    <div
                        ...
                        <div class="flex">
                            <div class="media-aside align-self-start">
                                <div
                                    class="shrink-0 ring-2 ring-white-light dark:ring-dark rounded-full ltr:mr-4 rtl:ml-4">
                ...
                <div class="panel h-full">
                    <div
                        ...
                        <a href="javascript:;" class="flex font-semibold">
                            <div
                                class="shrink-0 bg-secondary w-10 h-10 rounded-md flex items-center justify-center text-white ltr:mr-4 rtl:ml-4">
                                <span>FD</span>
                            </div>
                            <div>
                                <h6>Figma Design</h6>
