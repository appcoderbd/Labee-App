            ...
            <div class="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ltr:-ml-1 rtl:-mr-1 inline" src="/assets/images/logo.svg"
                        alt="image" />
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">LABEE</span>
                </a>
            ...
            <div x-data="header"
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <li class="mb-5">
                            <div class="overflow-hidden relative rounded-t-md !p-5 text-white">
                                <div
                                    class="absolute h-full w-full bg-[url('{{asset('/assets/images/menu-header.jpg')}}')] bg-no-repeat bg-center bg-cover inset-0">
                                </div>
                ...
                <div class="dropdown flex-shrink-0" x-data="dropdown" @click.outside="open = false">
                    ...
                    <ul x-cloak x-show="open" x-transition x-transition.duration.300ms
                        ...
                        <li>
                            <a href="{{route('user.profile')}}" class="dark:hover:text-white" @click="toggle">
                        ...
                        <li class="border-t border-white-light dark:border-white-light/10">
                            <a href="{{ route('logout') }}" class="text-danger !py-3"
